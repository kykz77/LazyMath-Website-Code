...
import UserInstruc from "$lib/use-instruc.svelte";
import ChatBot from "$lib/chat-bot.svelte";
  import UseInstruc from "$lib/use-instruc.svelte";
let searchTerm = "";
onMount(() => {
...
const card_infos = [
    ...
    {
        header: "How do I access the UDFs on my CAS?",
        body: ""
    },
    {
...
<div class = "contact-info">
                ...
                <div class = "card-info">
                    <details>
                        ...
                        {:else if card.header == "My student software has expired, what do I do?"}
                            <p class = "card-main">Instead of the student software, you will still be able to transfer files to your CAS calculator via Nspire Connect.</p>
                        ...
                        {:else if card.header == "How do I access the UDFs on my CAS?"}
                            <UseInstruc></UseInstruc>
                        {:else}
    ...
    <div class = "contact-info-wrapper" id = "scrollToBottom">
        ...
        <p class = "contact-subtext">
            ...
            <a class = "contact-subtext" href="mailto:lazymath2024@gmail.com">lazymath2024@gmail.com</a>
        </p>
    </div>
</div>
<ChatBot></ChatBot>
